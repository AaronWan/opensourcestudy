...
public class RpcRuntimeException extends RuntimeException{
   ...
   */
  public RpcRuntimeException(String code) {
    this.code = code;
  }
   ...
   * @since 1.4
   */
  public RpcRuntimeException(Throwable cause, String code) {
    super(cause);
    this.code = code;
  }
   ...
   * @since 1.7
   */
  public RpcRuntimeException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace, String code) {
