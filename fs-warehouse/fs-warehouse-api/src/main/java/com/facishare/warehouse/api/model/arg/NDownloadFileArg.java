...
public class NDownloadFileArg extends WarehouseBaseArg {
  ...
  @Tag(5)
  private boolean cancelRemoteThumb;//是否取消远程缩略
  @Tag(6)
  ...
  public boolean isCancelRemoteThumb() {
    return cancelRemoteThumb;
  }

  public void setCancelRemoteThumb(boolean cancelRemoteThumb) {
    this.cancelRemoteThumb = cancelRemoteThumb;
  }
